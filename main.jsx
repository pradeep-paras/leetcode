...
class Login extends React.Component {
	...
	handleSubmit = (e) => {
		...
		if(this.state.email === '') {
			...
			this.setState({email_ErMsg:'Username is required', password_ErMsg:""});
			return;
		}
		// else if(!emailValid){
		// 	this.setState({displaytext:'show_block'});
		...
		// }
            ...
            this.setState({
				password_ErMsg:'Password is required', email_ErMsg:""
			});
		}
		else{
			this.setState({
				password_ErMsg:'', email_ErMsg:"",  displaytext:"hide_block",
			});
		}
